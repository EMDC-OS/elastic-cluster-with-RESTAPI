...
class CollectLog:
    ...
    def main(self):
        ...
        file_string = "/workspace/nvidia-examples/cnn/nvutils/log" + str(hvd_rank)  + ".txt"

        while not self.__stop:
            f_read = open(file_string, "r")
            f_read.write("@@@@@@@@@")
            f_read.close()
            time.sleep(0.5)
...
def daemonize():
    ...
    if pid > 0:
        ...
        if pid > 0:
            ...
            with open("/workspace/nvidia-examples/cnn/nvutils/daemon_pid.pid", "w") as pid_file:
